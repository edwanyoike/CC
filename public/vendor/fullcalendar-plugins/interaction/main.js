...
(function (global, factory) {
    ...
    ***************************************************************************** */
    ...
    /*
    Uses a "pointer" abstraction, which monitors UI event for both mouse and touch.
    Tracks when the pointer "drags" on a certain element, meaning down+move+up.

    Also, tracks if there was touch-scrolling.
    Also, can prevent touch-scrolling from happening.
    Also, can fire pointermove event when scrolling happens underneath, even when no real pointer movement.
    ...
    */
    var PointerDragging = /** @class */ (function () {
        function PointerDragging(containerEl) {
            ...
            this.selector = ''; // will cause subjectEl in all emitted event to be this element
            this.handleSelector = '';
    ...
    // Ignoring fake mouse event generated by touch
    // ----------------------------------------------------------------------------------------------------
    ...
    */
    var FeaturefulElementDragging = /** @class */ (function (_super) {
        ...
        FeaturefulElementDragging.prototype.tryStopDrag = function (ev) {
            // .stop() is ALWAYS asynchronous, which we NEED because we want all pointerup event
    ...
    */
    var HitDragging = /** @class */ (function () {
        function HitDragging(dragging, droppableStore) {
            ...
            this.requireInitial = true; // if doesn't start out on a hit, won't emit any event
    ...
    */
    ...
    var EventDragging = /** @class */ (function (_super) {
        ...
        function EventDragging(settings) {
            ...
            _this.relevantEvents = null; // the event being dragged
    ...
    Interprets any dragging as an attempt to drag an event that lives outside
    ...
    */
    ...
    This class simply monitors for pointer movements and fires event.
