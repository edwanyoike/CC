...
// Used for namespacing event added to the document by each instance, so they
// can be removed on destroy
var _instCounter = 0;

// Button namespacing counter for namespacing event on individual buttons
...
$.extend( Buttons.prototype, {
	...
	destroy: function ()
	{
		...
		// Individual button destroy (so they can remove their own event if
